...
\begin{equation}
E(a) = -\frac{\pi^2}{1440a^3} \label{eq:EnergiaEntrePlacas} %- \frac{1}{8\pi} \int_0^\infty k_\perp^2 dk_\perp. 
\end{equation}
...
Tais valores de força \eqref{eq:EnergiaEntrePlacas} e pressão \eqref{eq:pressaoEntreAsPlacas} serão comparados com cenários diferentes, em que adicionaremos parâmetros relacionado a uma dimensão extra e a um campo éter acoplado a essa quinta dimensão.